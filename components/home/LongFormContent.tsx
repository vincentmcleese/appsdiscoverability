  ...
  return (
    <section className="w-full bg-white py-16 md:py-24">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
        <h2 className="text-3xl md:text-4xl lg:text-5xl font-normal tracking-tight text-ghost-text mb-12 text-center">
          Why Discoverability Matters in ChatGPT
        </h2>
        
        <div className="prose prose-lg prose-gray max-w-none">
          <p className="text-lg md:text-xl text-gray-700 leading-relaxed mb-6">
            When Apple launched the App Store in 2009, there were 6 million iPhones in distribution. Today, ChatGPT has 850 million weekly users. That's over 10% of the global population - and OpenAI just released the Apps SDK. The opportunity to build inside ChatGPT is enormous, and companies are already rushing to do it.
          </p>
          ...
          <p className="text-lg md:text-xl text-gray-700 leading-relaxed mb-6">
            Just like the mobile App Store, building great applications will be critical. But a great app is nothing without discoverability. As the ecosystem fills with apps, it will become your single biggest bottleneck to growth. The teams that crack it will be the ones that succeed.
          </p>
          ...
          <p className="text-lg md:text-xl text-gray-700 leading-relaxed">
            That's why we're building PromptRank. We track where your app ranks across both the store and organic recommendations. We show you which keywords and prompts your competitors are winning. And we give you specific actions to climb - so you're not just building a great app, but making sure it gets found.
          </p>
        </div>
      </div>
    </section>
