      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
        ...
        <div className="prose prose-lg prose-gray max-w-none">
          <p className="text-lg md:text-xl text-gray-700 leading-relaxed mb-6">
            When Apple launched the App Store in 2009, there were 6 million iPhones in distribution. Today, ChatGPT has 850 million weekly users. That's over 10% of the global population—and OpenAI has released the Apps SDK. The opportunity to build inside ChatGPT is enormous, and companies are already rushing to do it.
          </p>
