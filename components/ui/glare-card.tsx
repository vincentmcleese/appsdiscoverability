...
export const GlareCard = ({
  ...
  const backgroundStyle = {
    ...
    "--rainbow":
      "repeating-linear-gradient( 0deg,rgba(6,182,212,1) calc(var(--step) * 1),rgba(34,211,238,1) calc(var(--step) * 2),rgba(103,232,249,1) calc(var(--step) * 3),rgba(34,211,238,1) calc(var(--step) * 4),rgba(6,182,212,1) calc(var(--step) * 5),rgba(34,211,238,1) calc(var(--step) * 6),rgba(103,232,249,1) calc(var(--step) * 7) ) 0% var(--bg-y)/200% 700% no-repeat",
    "--diagonal":
      "repeating-linear-gradient( 128deg,rgba(8,51,68,0.3) 0%,rgba(6,182,212,0.3) 3.8%,rgba(34,211,238,0.3) 4.5%,rgba(6,182,212,0.3) 5.2%,rgba(8,51,68,0.3) 10%,rgba(8,51,68,0.3) 12% ) var(--bg-x) var(--bg-y)/300% no-repeat",
    "--shade":
      "radial-gradient( farthest-corner circle at var(--m-x) var(--m-y),rgba(34,211,238,0.2) 12%,rgba(6,182,212,0.2) 20%,rgba(34,211,238,0.3) 120% ) var(--bg-x) var(--bg-y)/300% no-repeat",
